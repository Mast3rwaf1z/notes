...

{
  ...
  fileSystems."/" =
    { device = "/dev/disk/by-uuid/045e656c-37b2-401e-aca4-d88018b5cb01";
      fsType = "ext4";
    };
  ...
  fileSystems."/home" =
    { device = "/dev/disk/by-uuid/36aeaffe-7c6f-41e4-a9ce-24ec5d795eb6";
      fsType = "ext4";
    };

  fileSystems."/boot" =
    { device = "/dev/disk/by-uuid/B2A0-1553";
      fsType = "vfat";
    };
